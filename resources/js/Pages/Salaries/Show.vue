                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                        ...
                        <div class="mt-4 flex items-center gap-4">
                            <span class="bg-white text-blue-600 px-4 py-1 rounded-full text-sm font-semibold">
                                {{ salary.month }}
                            </span>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="text-sm text-gray-600">Xodim</label>
                                    <p class="font-medium text-gray-900">{{ salary.user?.name }}</p>
                                </div>

                                <div>
                                    <label class="text-sm text-gray-600">Lavozim</label>
                                    <p class="font-medium text-gray-900">{{ salary.user?.position || '-' }}</p>
                                </div>

                                <div>
                                    <label class="text-sm text-gray-600">Workshop</label>
                                    <p class="font-medium text-gray-900">{{ salary.workshop?.name || '-' }}</p>
                                </div>

                                <div v-if="salary.branch">
                                    <label class="text-sm text-gray-600">Filial</label>
                                    <p class="font-medium text-gray-900">{{ salary.branch?.name || '-' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="text-sm text-gray-600">To'lov usuli</label>
                                    <p class="font-medium text-gray-900">{{ getPaymentMethodLabel(salary.payment_method) }}</p>
                                </div>

                                <div>
                                    <label class="text-sm text-gray-600">To'lagan shaxs</label>
                                    <p class="font-medium text-gray-900">{{ salary.paid_by?.name || '-' }}</p>
                                </div>

                                <div>
                                    <label class="text-sm text-gray-600">To'lov sanasi</label>
                                    <p class="font-medium text-gray-900">{{ formatDate(salary.payment_date) }}</p>
                                </div>

                                <div>
                                    <label class="text-sm text-gray-600">Yaratilgan</label>
                                    <p class="font-medium text-gray-900">{{ formatDate(salary.created_at) }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 p-6 bg-gray-50 rounded-lg">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-700">Asosiy maosh:</span>
                                    <span class="font-medium text-gray-900">{{ formatCurrency(salary.amount) }}</span>
                                </div>
                                ...
                                <div class="border-t-2 border-gray-300 pt-3 mt-3">
                                    <div class="flex justify-between items-center">
                                        <span class="text-lg font-bold text-gray-900">Jami to'langan:</span>
