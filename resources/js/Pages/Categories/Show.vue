...
const reload = () => {
    router.get(route('categories.show', props.category.id), { ...filters }, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
    });
...
watch(() => [filters.stock_status, filters.per_page], reload);
                    ...
                    <div class="p-4">
                        ...
                        <div v-else class="py-12 text-center">
                            <p class="text-gray-500 dark:text-gray-400">
                                {{ filters.search || filters.stock_status ? 'Filtrga mos mahsulot topilmadi' : 'Bu kategoriyada hali mahsulot yo\'q' }}
                            </p>
                            <Link
