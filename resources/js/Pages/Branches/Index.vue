...
const deleteBranch = (branch) => {
    if (confirm(`Haqiqatan ham "${branch.name}" filialni o'chirmoqchimisiz?`)) {
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6">
                        <div v-if="branches.data.length > 0" class="overflow-x-auto">
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                                    <tr v-for="branch in branches.data" :key="branch.id">
                                        <td class="whitespace-nowrap px-6 py-4">
                                            ...
                                            <div v-if="branch.address" class="text-sm text-gray-500 dark:text-gray-400">
                                                {{ branch.address }}
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <span class="inline-flex rounded-full bg-blue-100 px-2 text-xs font-semibold leading-5 text-blue-800 dark:bg-blue-800 dark:text-blue-100">
                                                {{ branch.users_count || 0 }} ta
                                            </span>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <span v-if="branch.is_active" class="inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800 dark:bg-green-800 dark:text-green-100">
                                                Faol
                                            </span>
                            ...
                            <!-- Pagination -->
                            <div v-if="branches.links.length > 3" class="mt-4 flex justify-center">
                        ...
                        <div v-else class="text-center py-12">
                            <p class="text-gray-500 dark:text-gray-400">Hali filiallar yo'q</p>
                            <Link
                                :href="route('branches.create')"
